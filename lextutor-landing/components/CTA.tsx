...
export default function CTA() {
  ...
  return (
    <section
      ref={containerRef}
      className="cta-section relative py-20 md:py-32 overflow-hidden flex items-center justify-center min-h-[52vh] md:min-h-[60vh] bg-foreground text-background"
    >
      ...
      <div className="cta-content relative z-10 max-w-3xl mx-auto text-center px-4 md:px-6">
        ...
        <p className="cta-subtext text-secondary/80 text-base md:text-xl mb-8 md:mb-12 max-w-2xl mx-auto leading-relaxed">
          Join the legal professionals using LexTutor to amplify their expertise
          with intelligent, agentic workflows.
        </p>
        <div className="flex flex-col sm:flex-row justify-center gap-3 md:gap-4">
          <Button
            size="lg"
            className="cta-primary-btn rounded-full h-12 md:h-14 px-7 md:px-8 text-[0.95rem] md:text-base font-medium bg-background text-foreground hover:bg-background/90 hover:-translate-y-[2px] transition-all duration-[180ms] shadow-lg hover:shadow-xl"
          >
          ...
          <Button
            variant="outline"
            size="lg"
            className="rounded-full h-12 md:h-14 px-7 md:px-8 text-[0.95rem] md:text-base font-medium border-background/20 text-background bg-transparent hover:bg-background/10 hover:-translate-y-[2px] transition-all duration-[180ms]"
          >
