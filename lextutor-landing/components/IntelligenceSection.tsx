...
export default function IntelligenceSection() {
  ...
  return (
    <section
      id="intelligence"
      ref={containerRef}
      className="intelligence-section relative overflow-hidden bg-[#EEEEEE] h-[90vh] py-20 lg:py-0"
    >
          ...
          <div className="flex flex-col justify-center h-full">
            <div className="w-full max-w-2xl text-left">
              ...
              <h2 className="font-sans mb-2 text-3xl font-black leading-[1.05] tracking-[-0.03em] text-slate-900 md:text-4xl lg:text-[2.8rem] xl:text-[3.2rem]">
                <span className="intelligence-headline-line block">
                  Powered by
                </span>
                <span className="intelligence-headline-line block text-[#57B7E9] mt-1">
                  Agentic
                </span>
                <span className="intelligence-headline-line block mt-1">
                  Legal
                </span>
                <span className="intelligence-headline-line block mt-1">
                  Intelligence
              ...
              <p className="intelligence-subtext mb-6 mt-4 max-w-xl font-sans text-[0.95rem] leading-relaxed text-gray-700 md:text-base">
                Our architecture does not just process text. It maps legal
                relationships and surfaces logical inconsistencies in real time.
              </p>
              ...
              <ul className="mt-1 pb-1">
                {FEATURES.map(({ title, description }) => (
                  <li key={title} className="intelligence-feature">
                    ...
                    <p className="font-sans text-[1rem] font-bold text-slate-900 md:text-[1.01rem]">
                      {title}
                    </p>
                    <p className="mt-1 font-sans text-sm leading-snug text-slate-600 md:text-[0.95rem]">
                      {description}
                    </p>
                  </li>
                ))}
